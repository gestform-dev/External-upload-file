...
import { RedirectionGuard } from './guards/redirection-to-login.guard'

export const routes: Routes = [
  { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
  { path: 'offline', component: OfflineComponent },
  // Cannot have path with only redirectionGuard, need to add a component or children to fix issue
  { path: 'logout',  canActivate: [RedirectionGuard], children: [] },
  {
    path: '',
