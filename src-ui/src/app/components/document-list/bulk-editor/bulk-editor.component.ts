  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    ...
    if (this.permissionService.currentUserCan(this.PermissionAction.View, this.PermissionType.Tag)) {
      this.tagService
      .listAll()
      .pipe(first())
      .subscribe((result) => (this.tags = result.results))
    }
    if (this.permissionService.currentUserCan(this.PermissionAction.View, this.PermissionType.Correspondent)) {
      this.correspondentService
      .listAll()
      .pipe(first())
      .subscribe((result) => (this.correspondents = result.results))
    }
    if (this.permissionService.currentUserCan(this.PermissionAction.View, this.PermissionType.DocumentType)) {
      this.documentTypeService
      .listAll()
      .pipe(first())
      .subscribe((result) => (this.documentTypes = result.results))
    }
    if (this.permissionService.currentUserCan(this.PermissionAction.View, this.PermissionType.StoragePath)) {
