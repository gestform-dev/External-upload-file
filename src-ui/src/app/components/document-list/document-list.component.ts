...
import { PermissionAction, PermissionType, PermissionsService } from 'src/app/services/permissions.service'
...
export class DocumentListComponent
  ...
  getSortFields() {
    return isFullTextFilterRule(this.list.filterRules)
      ? this.documentService.DOCUMENT_SORT_FIELDS_FULLTEXT
      : this.documentService.DOCUMENT_SORT_FIELDS
  }
  ...
  openDocumentDetail(document: PaperlessDocument) {
    if (this.permissionsService.currentUserCan(PermissionAction.View, PermissionType.AdvanceUi)
      && this.permissionsService.currentUserCan(PermissionAction.Change, PermissionType.Document)) {
