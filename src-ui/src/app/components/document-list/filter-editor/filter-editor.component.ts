...
export class FilterEditorComponent extends ComponentWithPermissions implements OnInit, OnDestroy {
  generateFilterName() {
  ...
  ngOnInit() {
    if(this.permissionsService.currentUserCan(this.PermissionAction.View, this.PermissionType.Tag)) {
      this.tagService
        .listAll()
        .subscribe((result) => (this.tags = result.results))
    }
    if(this.permissionsService.currentUserCan(this.PermissionAction.View, this.PermissionType.Correspondent)) {
      this.correspondentService
        .listAll()
        .subscribe((result) => (this.correspondents = result.results))
    }
    if(this.permissionsService.currentUserCan(this.PermissionAction.View, this.PermissionType.DocumentType)) {
      this.documentTypeService
        .listAll()
        .subscribe((result) => (this.documentTypes = result.results))
    }
    if(this.permissionsService.currentUserCan(this.PermissionAction.View, this.PermissionType.StoragePath)) {
