...
import { appFrame } from '../../config'
import { CONFIDENTIALITY_POLICY_FILE_PATH } from 'src/app/constants/variables'
...
export class AppFrameComponent
  ...
  confidentialityPolicyFilePath = CONFIDENTIALITY_POLICY_FILE_PATH
