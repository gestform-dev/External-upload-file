...
class HeicTestCase(TestCase):

    def test_isHeif(self):
        mocked_result = [Consumer()._isHeif("image/heif"),
        Consumer()._isHeif("image/heic"),
        Consumer()._isHeif("image/png")]

        expected_result = [True,True,False]

        self.assertEqual(expected_result, mocked_result )

    def test_get_ouputPath_from_inputPath(self):
        mocked_result = [Consumer()._get_ouputPath_from_inputPath("image/file.heic"),
        Consumer()._get_ouputPath_from_inputPath("myheicimage/file.HEIC"),
        Consumer()._get_ouputPath_from_inputPath("myheicimage/file.jpg")]

        expected_result = ["image/file.jpg",
        "myheicimage/file.jpg",
        "myheicimage/file.jpg",
        ]
